...
Every failure inside notion-agent raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`notion_agent.cli._output`,
...
# Exit-code policy. Documented in ``notion-agent learn`` output.
# 0      = success
